---
title: 'Analyze Your Data with R in Simple Steps'
author:
  Shehab A. Habila (Biostatistician, R programmer), Hossam M. Ghorab (Biostatistician, R programmer)
output:
  html_notebook:
    toc: true
  pdf_document:
...
my_data <- readxl::read_excel("received/SH/my_data.xlsx")
...
write.csv(print(my_summary_table, nonnormal = nonnormal_vars, smd = TRUE), file = "myTable.csv")
# Save to a CSV file
```
